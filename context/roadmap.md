...
**Phase 3 chunks 3.1–3.5 shipped.** Panel entity + R17 lifecycle, notches, darts, landmark labels, and ease/gather notations all live. Cascade-on-edge-break + re-peg-on-edge-subdivide pattern proven across notches and darts; ease/gather adds a second-tier cascade (notch-removal cascades any ease/gather pointing at it). 204 → 295 tests green.
...
Next: **Phase 3 chunk 3.6 — Instruments, passive** (rulers + protractor first; french curves with trace-to-cubic-chain last). Standing assignment from 2026-04-23 (find one non-Justin hobby sewist) still pending.
